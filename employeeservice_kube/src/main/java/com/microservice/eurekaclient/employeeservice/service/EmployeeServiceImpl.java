...
import com.microservice.eurekaclient.employeeservice.controller.DepartmentServiceProxy;
...
import com.microservice.eurekaclient.employeeservice.repository.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService{
	 ...
	 */
	/*
	 * url is for restTemplate //static final String URL =
	...
	public EmployeeDepartmentResponse getEmployeeDepartment(int employeeId) {
		...
		//2.Get Department
//		String url = URL + employee.getDepartment_id();
